...
obj_files = sorted([f for f in os.listdir(base_path) if f.startswith(base_name) and f.endswith('.obj')])
...
for i, obj_file in enumerate(obj_files):
    ...
    if bpy.context.selected_objects:
        ...
        # Fix Kinect coordinate system (Y-up to Z-up)
...
"""
        ...
        print("   🔄 Includes automatic orientation correction")
...
def main():
    ...
    parser.add_argument("--export", action="store_true", help="Export mesh sequence")
